...
selected_tool = "ticket_advice"
if selected_tool == "station_code":
    result = {"station_name": station_name, "station_code": "VNP"}
elif selected_tool == "ticket_advice":
    result = {"train_no": train_no, "advice": "查看同方向其他订单编号，或尝试候补申请，不能保证成功。"}
elif selected_tool == "refund_rule":
    result = {"rule": "退变更以订单页面规则为准。"}
else:
