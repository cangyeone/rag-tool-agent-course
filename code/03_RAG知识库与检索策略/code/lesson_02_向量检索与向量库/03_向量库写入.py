...
运行方式：
    ...
    python code/03_RAG知识库与检索策略/code/lesson_02_向量检索与向量库/03_向量库写入.py
"""
...
def load_course_snippets() -> list[dict]:
    ...
    sample_files = [
        ...
        ("工具调用与Agent", "code/06_工具调用与Agent/code/README.md", 900),
    ]
    ...
    business_docs = [
        ...
        {
            "title": "服务点名称与编码",
            "content": "北京南、上海虹桥、杭州东等服务网点在系统中通常同时存在中文站名、拼音、服务点编码和城市信息。检索服务点资料时，关键词和语义检索可以结合使用。",
        },
        {
            "title": "学生优惠票说明",
            "content": "学生优惠票通常需要符合学生资质、使用服务区间和优惠次数等条件。系统核验结果、优惠区间和下单时间都会影响能否购买学生优惠票。",
        },
        {
            "title": "GPR安全检查记录",
