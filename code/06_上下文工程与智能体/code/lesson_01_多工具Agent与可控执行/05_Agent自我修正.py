...
print("【场景设定】")
user_query = "ORD-1001 没票了，我现在提交候补申请能保证上车吗？我赶时间必须走。"
...
print("── 第 1 轮：初始回答 ──")
first_answer = (
    "ORD-1001 目前没票了，您可以提交候补申请。候补申请成功后系统会自动分配座位，"
...
second_answer = (
    "ORD-1001 当前显示无票，您可以提交候补申请。"
    "但需要提醒您：候补申请不能保证一定成功，系统按排队顺序兑现，"
    "最终结果以 官方页面通知为准。"
    "同时建议您查看同方向其他服务编号（如 订单B、ORD-2001），目前仍有部分库存。"
    "如果您赶时间，替代服务编号可能是更稳妥的选择。"
)
...
print(f"   │ 替代方案: ❌                │ 替代方案: ✅(订单B, ORD-2001)      │")
