...
运行方式：
    python code/02_大模型接口与业务指令/code/lesson_01_本地模型与服务化过渡/04_DeepSeek_API调用.py
...
messages = [
    ...
    {
        "role": "user",
        "content": "G107 次服务流程标准服务没票了，我还能怎么办？请给出可操作建议。",
    },
]
...
payload_json = {
    ...
    "messages": [
        ...
        {
            "role": "user",
            "content": "请把这个问题分类为 json：G107 标准服务没票了，候补申请能保证成功吗？字段包括 intent、risk_level、answer。",
        },
    ],
    "thinking": {"type": "disabled"},
