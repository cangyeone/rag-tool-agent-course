...
tools = [
    {
        ...
        "function": {
            ...
            "description": "根据中文站名查询服务点编码，用于后续订单编号查询",
            "parameters": {
                "type": "object",
                "properties": {
                    "station_name": {
                        "type": "string",
                        "description": "中文站名，例如 北京南、上海虹桥"
                    }
                },
...
def query_station_code(station_name: str) -> str:
    """模拟服务点编码查询"""
    codes = {"北京南": "VNP", "上海虹桥": "AOH", "杭州东": "HZH"}
    return codes.get(station_name, "未知服务点")

def check_waiting_rules(train_no: str, date: str = None) -> str:
    """模拟候补申请规则查询"""
    return json.dumps({
        "can_wait": True,
...
# 工具注册表
TOOL_MAP = {
    "query_station_code": query_station_code,
...
# 使用
answer = run_agent("北京南的服务点编码是什么？G107 能候补申请吗？")
print(answer)
```
