...
raw_outputs.append({
    "name": "```think 代码块格式",
    "raw": "```think\n分析：用户想退款，需要确认服务开始时间。退款手续费按阶梯收取，越早退越便宜。\n```\n根据查询，退款手续费：服务开始前8天以上免收，48h以上收5%，24h以上收10%，24h内收20%。",
})
