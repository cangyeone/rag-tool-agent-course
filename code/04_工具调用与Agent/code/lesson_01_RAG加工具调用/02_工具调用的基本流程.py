...
def query_ticket(train_no: str) -> dict:
    ...
    return {
        ...
        "date": "2026-06-22",
        "remaining": 0,
        "suggestion": "可尝试候补申请，或查看同方向其他订单编号。",
    }


question = "G107 没票了，候补申请一定能成功吗？"
print("用户问题：", question)

# 第一步：人工写一个非常简单的规则，判断要用哪些工具。
need_ticket_tool = "G107" in question or "没票" in question
need_policy_tool = "候补申请" in question or "成功" in question

print("\n一、判断需要哪些工具")
print("需要库存工具：", need_ticket_tool)
...
if need_ticket_tool:
    ticket_result = query_ticket("G107")
...
answer = (
    ...
    "建议提交候补申请后继续关注订单状态，也可以查看同方向其他订单编号。"
    "最终以官方页面实时显示为准。"
)
...
print("2. 修改 query_ticket 的 remaining，观察最终回答应该怎么改。")
