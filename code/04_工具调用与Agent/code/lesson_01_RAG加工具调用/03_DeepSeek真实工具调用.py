...
运行方式：
    ...
    python code/04_工具调用与Agent/code/lesson_01_RAG加工具调用/03_DeepSeek真实工具调用.py
"""
...
def query_ticket(train_no: str) -> dict:
    ...
    if train_no in ["T701", "T90"]:
        ...
        return f"查询失败，订单号{train_no}没有在数据库中。"
...
question = "G107 没票了，候补申请一定能成功吗？请给我一个稳妥答复。"
