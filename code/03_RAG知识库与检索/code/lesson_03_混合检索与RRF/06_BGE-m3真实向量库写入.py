...
运行方式：
    ...
    python code/03_RAG知识库与检索/code/lesson_03_混合检索与RRF/06_BGE-m3真实向量库写入.py
"""
...
def load_documents() -> list[dict]:
    ...
    business_docs = [
        ...
        ("服务点名称与编码", "服务点A、服务点B、杭州东等服务网点在系统中通常同时存在中文服务点名称、拼音、服务点编码和城市信息。检索服务点资料时，关键词和语义检索可以结合使用。"),
        ("学生优惠票说明", "学生优惠票通常需要符合学生资质、使用服务区间和优惠次数等条件。系统核验结果、优惠区间和创建订单时间都会影响能否购买学生优惠票。"),
