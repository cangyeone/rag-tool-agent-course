...
运行方式：
    ...
    python code/04_工具调用与智能体/code/lesson_01_RAG加工具调用/01_DeepSeek直接选择工具.py
"""
...
tools = [
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "calc_refund_fee_fee",
            "description": "根据价格和距离服务开始小时数，估算退款费用。",
            "parameters": {
                "type": "object",
                "properties": {
                    "order_amount": {
...
question = "ORD-1001 今天还有标准服务吗？我购买了订单，价格 553 元，服务开始前 12 小时退款，手续费大概怎么算？"
